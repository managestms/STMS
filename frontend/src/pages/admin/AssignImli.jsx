...
const AssignImli = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    alert(`Assigned ${formData.amount} KG to Cleaner ${formData.cleanerId}`)
    ...
    <div className="p-8 bg-gray-100 min-h-screen flex items-center justify-center">
      <div className="bg-white rounded-lg p-12 w-full max-w-md shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          <h2 className="text-2xl font-bold mb-6">ASSIGN IMLI</h2>
          ...
          <input
            type="text"
            name="amount"
            placeholder="Amount of Imli to be assigned"
